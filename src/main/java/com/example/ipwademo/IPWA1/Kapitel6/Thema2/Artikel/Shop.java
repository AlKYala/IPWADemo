...
public class Shop {
    ...
    private void initData() {
        ...
        artikelList.add(new Artikel(0,
                "Bleu de Chanel 50ml EDT",
                "Nur einmal benutzt",
                "https://i.imgur.com/QAQwRdE.jpeg", 85, 0));

        artikelList.add(new Artikel(1,
